...
CREATE TABLE `vendas` (
  ...
  KEY `COD_ESTABELECIMENTO` (`COD_ESTABELECIMENTO`),
  KEY `COD_COLABORADOR` (`COD_COLABORADOR`),
  CONSTRAINT `vendas_ibfk_1` FOREIGN KEY (`COD_ESTABELECIMENTO`) REFERENCES `estabelecimento` (`COD_ESTABELECIMENTO`),
...
-- Dump completed on 2015-06-22 12:10:51
