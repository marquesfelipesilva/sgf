<?php
	class Cadastro{
		public function cadastrar($NO_COLABORADOR, $DS_FUNCAO, $DS_LOGIN, $DS_SENHA){
			...
			if($contar == 0){
			$insert=mysql_query("INSERT INTO colaborador(NO_COLABORADOR, DS_FUNCAO, DS_LOGIN, DS_SENHA, NIVEL, STATUS)VALUES('$NO_COLABORADOR','$DS_FUNCAO','$DS_LOGIN','$DS_SENHA', 1, 0)");}else{
